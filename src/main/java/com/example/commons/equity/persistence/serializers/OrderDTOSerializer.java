...
public class OrderDTOSerializer implements JsonSerializer<OrderDTO> {
    ...
    public JsonElement serialize(OrderDTO orderDTO, Type type, JsonSerializationContext jsonSerializationContext) {
        ...
        jsonObject.add("PORTFOLIO_ID",jsonSerializationContext.serialize(orderDTO.portfolioId(),String.class));
        ...
        jsonObject.add("THEORETICAL QUANTITY",jsonSerializationContext.serialize(orderDTO.theoreticalQuantity(),Integer.class));
        jsonObject.add("QUANTITY",jsonSerializationContext.serialize(orderDTO.quantity(),Integer.class));
